...
import com.voyager.Login.LoginActivity;
import com.voyager.Login.ShareLogin.RegisterPage;
import com.voyager.upan_location_client.util.Location_client;
import com.voyager.widgets.DetailActivity;
import com.voyager.widgets.RecyclerViewAdapter;
import com.voyager.widgets.ViewModel;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, RecyclerViewAdapter.OnItemClickListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            ComponentName componentName = new ComponentName(this, Location_client.class);
            map_intent.setComponent(componentName);
